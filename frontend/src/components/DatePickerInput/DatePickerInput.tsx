...
export default function DatePickerInput({ value, onChange, minDate, maxDate }: Props) {
  ...
  const goBack = () => setViewDate(subMonths(viewDate, 1));
  const goForward = () => setViewDate(addMonths(viewDate, 1));
      ...
      <BottomSheet isOpen={isOpen} onClose={() => setIsOpen(false)} title="Select Date">
        <div className={styles.calendar}>
          ...
          <div className={styles.header}>
            ...
            <button type="button" className={styles.navBtn} onClick={goForward}>
